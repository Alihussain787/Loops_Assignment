...
var num = 0;
while (!correctGuessNumber && num < currentGuessNumber.length) {
    var currentGuess = currentGuessNumber[num];
    if (currentGuess === randomNumber) {
        console.log("Congrats you have gussed currect number ".concat(currentGuess));
...
// for in loop to get properties names and values from object
